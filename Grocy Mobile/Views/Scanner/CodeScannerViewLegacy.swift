...
import SwiftUI
    ...
    public struct CodeScannerViewLegacy: UIViewControllerRepresentable {
        ...
        public func makeUIViewController(context: Context) -> ScannerViewControllerLegacy {
            return ScannerViewControllerLegacy(showViewfinder: showViewfinder, parentView: self, isPaused: $isPaused)
        }

        public func updateUIViewController(_ uiViewController: ScannerViewControllerLegacy, context: Context) {
    ...
    @available(macCatalyst 14.0, *)
    extension CodeScannerViewLegacy {

        public class ScannerViewControllerLegacy: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, AVCaptureMetadataOutputObjectsDelegate {

            var parentView: CodeScannerViewLegacy!
            @Binding var isPaused: Bool
            ...
            public init(showViewfinder: Bool = false, parentView: CodeScannerViewLegacy, isPaused: Binding<Bool>) {
    ...
    struct CodeScannerView_Previews: PreviewProvider {
        static var previews: some View {
            CodeScannerViewLegacy(codeTypes: [.qr]) { result in
                // do nothing
            }
        }
    }
